...
// The original code can be found at `inet/linklayer/ieee80211/mac/Mac.cc` of INET-4.4.1


#include "../../../inet/linklayer/ieee80211/SatelliteMac.h"
...
void SatelliteMac::initializeRadioMode() {
...
const MacAddress& SatelliteMac::isInterfaceRegistered()
{
//    if (!par("multiMac"))
...
void SatelliteMac::configureNetworkInterface()
{
...
void SatelliteMac::handleMessageWhenUp(cMessage *message)
{
...
void SatelliteMac::handleSelfMessage(cMessage *msg)
{
    ASSERT(false);
}

void SatelliteMac::handleMgmtPacket(Packet *packet)
{
...
void SatelliteMac::handleUpperPacket(Packet *packet)
{
...
void SatelliteMac::handleLowerPacket(Packet *packet)
{
...
void SatelliteMac::handleUpperCommand(cMessage *msg)
{
...
void SatelliteMac::encapsulate(Packet *packet)
{
...
void SatelliteMac::decapsulate(Packet *packet)
{
...
void SatelliteMac::receiveSignal(cComponent *source, simsignal_t signalID, intval_t value, cObject *details)
{
...
void SatelliteMac::configureRadioMode(IRadio::RadioMode radioMode)
{
...
void SatelliteMac::sendUp(cMessage *msg)
{
...
void SatelliteMac::sendUpFrame(Packet *frame)
{
...
void SatelliteMac::sendDownFrame(Packet *frame)
{
...
void SatelliteMac::sendDownPendingRadioConfigMsg()
{
    if (pendingRadioConfigMsg != nullptr) {
...
void SatelliteMac::processUpperFrame(Packet *packet, const Ptr<const Ieee80211DataOrMgmtHeader>& header)
{
...
void SatelliteMac::processLowerFrame(Packet *packet, const Ptr<const Ieee80211MacHeader>& header)
{
...
// FIXME
void SatelliteMac::handleStartOperation(LifecycleOperation *operation)
{
    if (!operation)
...
// FIXME
void SatelliteMac::handleStopOperation(LifecycleOperation *operation)
{
}

// FIXME
void SatelliteMac::handleCrashOperation(LifecycleOperation *operation)
{
}
