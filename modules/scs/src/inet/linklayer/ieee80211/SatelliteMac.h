...
// The original code can be found at `inet/linklayer/ieee80211/mac/Mac.h` of INET-4.4.1.
 ...
 */
class INET_API SatelliteMac : public MacProtocolBase
{
  protected:
    FcsMode fcsMode;
