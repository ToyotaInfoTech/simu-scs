...
// The original code can be found at `external/inet/visualizer/canvas/mobility/MobilityCanvasVisualizer.cc`. 

#include "../../../../inet/visualizer/canvas/mobility/SCSMobilityCanvasVisualizer.h"
...
Define_Module(SCSMobilityCanvasVisualizer);

SCSMobilityCanvasVisualizer::MobilityCanvasVisualization::~MobilityCanvasVisualization()
{
...
SCSMobilityCanvasVisualizer::MobilityCanvasVisualization::MobilityCanvasVisualization(cOvalFigure *positionFigure, cPieSliceFigure *orientationFigure, cLineFigure *velocityFigure, TrailFigure *trailFigure, IMobility *mobility) :
...
void SCSMobilityCanvasVisualizer::initialize(int stage)
{
...
void SCSMobilityCanvasVisualizer::refreshDisplay() const
{
...
void SCSMobilityCanvasVisualizer::addMobilityVisualization(const IMobility *mobility, MobilityVisualization *mobilityVisualization)
{
...
void SCSMobilityCanvasVisualizer::removeMobilityVisualization(const MobilityVisualization *mobilityVisualization)
{
    auto canvas = visualizationTargetModule->getCanvas();
...
SCSMobilityCanvasVisualizer::MobilityVisualization *SCSMobilityCanvasVisualizer::createMobilityVisualization(IMobility *mobility)
{
...
void SCSMobilityCanvasVisualizer::extendMovementTrail(const IMobility *mobility, TrailFigure *trailFigure, cFigure::Point position) const
{
