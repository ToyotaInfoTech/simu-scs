...
// The original code can be found at `external/inet/visualizer/canvas/mobility/MobilityCanvasVisualizer.h`. 

#ifndef __INET_SCSMOBILITYCANVASVISUALIZER_H
#define __INET_SCSMOBILITYCANVASVISUALIZER_H
...
class INET_API SCSMobilityCanvasVisualizer : public MobilityVisualizerBase
{
  protected:
